...
password modes on Ubuntu 22.04 and 24.04. Gated disposable QEMU/libvirt and
Tart VM suites cover systemd, Snap, sshd, networking, firewall, WireGuard,
...
runner requirements, and the CI security boundary.
